...
<tr><tr><tr><tr><tr></tr></tr></tr></tr></tr>
 ...
 <div id="global">
         ...
         <form modelAttribute="product" action="<c:url value="/saveimage" />" method="post" enctype="multipart/form-data">
        <fieldset>
        ...
        <%-- <form:form modelAttribute="product" action="saveimage" method="post" enctype="multipart/form-data">
        <fieldset>
                <legend>Add a product</legend>
