    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        .authorizeRequests()
                .antMatchers("/", "/home","/getRegistrationForm", "/getloginForm","/getUserTable","/getDownload","/getContuctUs","/getForgetPasswordForm","/processForgetPassword","/getresetpassword",
                		"/resetpassword","/processRegistration","/imageViewer/**","/getrulesandregulations","/getfipdefination","/registrationconfirm","/getloginFormAfterRegister","/getregisterjudge","/registerjudge").permitAll()    
