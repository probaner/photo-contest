...
public class SelectData {
   ...
   public Map<String,String> countryData(){
	   ...
	   countryList.put("�land Islands","�land Islands");
	   ...
	   countryList.put("C�te d'Ivoire","C�te d'Ivoire");
	   countryList.put("Croatia","Croatia");
	   countryList.put("Cuba","Cuba");
	   countryList.put("Cura�ao","Cura�ao");
